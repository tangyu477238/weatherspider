...
//    static String s_stock_account = "0268411912";
    ...
    static String hs_openid = "10918505202";
...
//
     ...
     * @throws Exception
     */
    public static String hungSell(String stock_code, String stock_name, String original_price, String current_price,
                                 int entrust_amount, String access_token) throws Exception{
     ...
     * @throws Exception
     */
    public static String stopProfitAndLoss(String stock_code, String stock_name,
        ...
        String url = "https://tjd.cczq.com:5000/cczq/biz/v/stopProfitAndLoss?stock_code="+stock_code
                +"&stock_name="+stock_name+"&base_price="+base_price
                ...
                +"&exchange_type="+exchange_type +"&current_price="+current_price+"&cep_type="+cep_type+"&expiry_days="+expiry_days
                +"&expiry_days_text="+expiry_days_text+"&entrust_price_type="+entrust_price_type+"&entrust_amount="+entrust_amount
                +"&stock_account="+stock_account+"&entrust_price_mode="+entrust_price_mode+"&comp_id="+comp_id+"&hs_openid="+hs_openid
                +"&access_token="+access_token+"&fund_account="+fund_account+"&op_station="+op_station+"&ext="+ext;
        log.info("");
